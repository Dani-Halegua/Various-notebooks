 The goal of this project is to familiarize myself with web scraping using the ``BeautifulSoup`` library and bonus point if I can get myself some movie plans for the weekends :).
